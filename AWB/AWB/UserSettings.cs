...
namespace AutoWikiBrowser
{
    partial class MainForm
    {
        ...
        private void LoadDefaultEditSummaries()
        {
            ...
            cmboEditSummary.Items.Add("تمیزکاری");
            cmboEditSummary.Items.Add("رده‌بندی مجدد برپایهٔ [[ویکی‌پدیا:سیاست_حذف_رده‌ها]]");
            cmboEditSummary.Items.Add("حذف و رده‌بندی مجدد برپایهٔ [[ویکی‌پدیا:سیاست_حذف_رده‌ها]]");
            cmboEditSummary.Items.Add("حذف رده بر پایهٔ [[ویکی‌پدیا:سیاست_حذف_رده‌ها]]");
            cmboEditSummary.Items.Add("تراگنجایش الگو");
            cmboEditSummary.Items.Add("مرتب‌کردن خرد");
            cmboEditSummary.Items.Add("اصلاح اشتباه سهوی");
            cmboEditSummary.Items.Add("اصلاح پیونددهی اشتباه");
            cmboEditSummary.Items.Add("اصلاح پیوند به صفحهٔ ابهام‌زدایی");
            cmboEditSummary.Items.Add("جایگزینی");
        }
