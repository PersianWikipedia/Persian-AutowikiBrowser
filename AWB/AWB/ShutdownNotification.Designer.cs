namespace AutoWikiBrowser
{
    partial class ShutdownNotification
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtPrompt.Text = "ویرایشگر خودکار پردازشش تمام شد و  برای {0} تنظیم شده‌است. اگر قصد جلوگیری دارید،" +
    " دکمهٔ لغو را کلیک کنید وگرنه {0} بر روی رایانه اعمال می‌شود.";
            // 
            // lblTimer
            // 
            ...
            this.lblTimer.Size = new System.Drawing.Size(163, 13);
            this.lblTimer.TabIndex = 4;
            this.lblTimer.Text = "زمان تا <ShutdownType>: <time>";
            // 
            // countdownTimer
            // 
