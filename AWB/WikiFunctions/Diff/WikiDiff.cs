...
namespace WikiFunctions
{
  ...
  <td colspan='2' class='diff-lineno'>خط {0}:</td>
  <td colspan='2' class='diff-lineno'>خط {1}:</td>
...
<col class='diff-content' />";
        public static string TableHeader
        {
            get
            {
                string th = @"<br/><p style='font-size:120%;' dir='rtl' color='red' style='margin: 0px;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;با دوبار کلیک بر روی خط تغییریافته، آن تغییر واگردانی می‌شود و با یک کلیک تمرکز موس بر روی متن درون جعبه ویرایش می‌رود.</p>
" + DiffColumnClasses + @"
<thead>
  <tr valign='top'>";
                ...
                if (!Variables.RTL)
                    th = th + @"
    <td colspan='2' width='50%' class='diff-ntitle'>متن جدید</td>
    <td colspan='2' width='50%' class='diff-otitle'>متن کنونی</td>";
                else
                    th = th + @"
    <td colspan='2' width='50%' class='diff-otitle'>متن کنونی</td>
    <td colspan='2' width='50%' class='diff-ntitle'>متن جدید</td>";
